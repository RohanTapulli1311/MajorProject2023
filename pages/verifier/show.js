      ...
      <Layout>
        ...
        <Grid>
          <Grid.Row>
            ...
            <Card>
              <Card.Content>
                <Card.Header>Verify Documents</Card.Header>
                <Card.Description>
                  View documents sent for verification on the blockchain
                </Card.Description>
                <Link legacyBehavior route={`/verifier/${this.props.addr}/verify`}>
                <a>
                  <Button
                    floated="right"
                    content="Open"
